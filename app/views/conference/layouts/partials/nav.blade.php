<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand {{ Active::action('ConferenceController@index')  }} " href="{{ route('conferences_path') }}"> <i class="glyphicon glyphicon-home <?php if (isset($authenticated) && $authenticated === false) echo 'logged-out'; else echo 'logged-in'; ?>"></i> {{ Lang::get('menu.home') }}</a>
        </div>
