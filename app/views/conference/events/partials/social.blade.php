...
<div class="row text-center">
    ...
    <div class="col-xs-4 col-sm-12 col-md-12 nopadding"><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ Config::get('uninett.base_url') }}/{{ $session['links']['session']['uri'] }}" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><span class="fa fa-linkedin"></span></a></div>
</div>
