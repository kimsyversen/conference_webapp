...
return array(
	...
	'list' => array(
		'1' => 'Cookies are used to store personal settings on each device you use to visit this page. As of today we use it to store language settings, determine if you previously have used the application, and the schedule layout.',
